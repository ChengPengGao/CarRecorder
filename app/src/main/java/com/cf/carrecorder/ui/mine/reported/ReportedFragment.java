...
public class ReportedFragment extends BaseFragment<ReportedView, ReportedPresenter> implements ReportedView {
    ...
    protected void initView(View view) {
        ...
        fragments.add(new ItemFragment(ItemFragment.REPORT_ALL));
        fragments.add(new ItemFragment(ItemFragment.REPORT_WAIT));
        fragments.add(new ItemFragment(ItemFragment.REPORT_SUCCESS));
        fragments.add(new ItemFragment(ItemFragment.REPORT_FAILED));
